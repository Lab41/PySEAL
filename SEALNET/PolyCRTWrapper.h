            ...
            */
            ...
            public:
                ...
                */
                ...
                <remarks>
                <para>
                Writes a given list of values (represented by <see cref="BigUInt"/>) into the slots of a given plaintext polynomial. 
                If the list contains non-zero entries for which the corresponding slots have not already been prepared using PrepareSlot(),
                they will be prepared before the value is set. This function runs on a single thread, and for improved performance 
                the user might instead want to call the functions AddToSlot(), or possibly SetSlot(), from multiple threads.
                </para>
                <para>
                ...
                */
                ...
                /**
                <summary>Writes a given list of values (represented by BigUInt) into the slots of a plaintext polynomial and returns
                it.</summary>

                <remarks>
                <para>
                Writes a given list of values (represented by <see cref="BigUInt"/>) into the slots of a plaintext polynomial and returns it. 
                If the list contains non-zero entries for which the corresponding slots have not already been prepared using PrepareSlot(),
                they will be prepared before the value is set. This function runs on a single thread, and for improved performance the user
                ...
                */
                ...
                /**
                <summary>Reads the values in the slots of a given plaintext polynomial and writes them as the entries of a given list.</summary>

                <remarks>
                <para>
                Reads the values in the slots of a given plaintext polynomial and writes them as the entries of a given list. This is the
                ...
                <para>
                The plaintext polynomial poly must have the same number of coefficients as the polynomial modulus, and its coefficients must have
                ...
                */
                ...
                /**
                <summary>Reads the values in the slots of a given plaintext polynomial and writes them as the entries of a list which is
                returned.</summary>

                <remarks>
                <para>
                Reads the values in the slots of a given plaintext polynomial and writes them as the entries of a list which is returned. This
                ...
                */
                ...
                /**
                <summary>Reads the value from a given slot of a given plaintext polynomial and writes it to a BigUInt given by
                reference.</summary>

                <remarks>
                <para>
                Reads the value from a given slot of a given plaintext polynomial and writes it to a <see cref="BigUInt"/> given by reference.
                </para>
                <para>
                ...
                <param name="poly">The plaintext polynomial from which the slot is read</param>
                ...
                */
                ...
                /**
                <summary>Reads the value from a given slot of a given plaintext polynomial and returns it as a BigUInt.</summary>

                <remarks>
                <para>
                Reads the value from a given slot of a given plaintext polynomial and returns it as a <see cref="BigUInt"/>.
                </para>
                <para>
                This function is particularly useful when the user wants to use multithreading to speed up reading values from slots of
                a polynomial.
                ...
                <para>
                The plaintext polynomial poly must have the same number of coefficients as the polynomial modulus, and its coefficients must
                ...
                */
                ...
                /**
                <summary>Adds a value (modulo the slot modulus) to the current value in a given slot of a plaintext polynomial.</summary>
                ...
                It is faster than SetSlot() and achieves the exact same thing when the polynomial is guaranteed to have a value of zero
                ...
                reduced modulo the slot modulus. The plaintext polynomial destination must have the same number of coefficients as the
                ...
                <param name="destination">The plaintext polynomial whose slot the value is added to</param>
                ...
                */
                ...
                /**
                <summary>Sets the value in a given slot of a plaintext polynomial to a given value.</summary>
                ...
                <para>
                This function is particularly useful when the user wants to use multithreading to speed up writing values to the slots.
                It is slower than AddToSlot() and achieves the exact same thing when the polynomial is guaranteed to have a value of zero
                in the particular slot that is being written to. If the slot to be added to has not already been prepared using
                PrepareSlot(), that will be done first.
                </para>
                <para>
                ...
                <param name="index">The index of the slot</param>
                <param name="destination">The plaintext polynomial whose slot is set to value</param>
                <exception cref="System::ArgumentNullException">if value or destination is null</exception>
                <exception cref="System::ArgumentException">if index is negative</exception>
                <exception cref="System::ArgumentException">if index is larger than or equal to the number of slots</exception>
                <exception cref="System::ArgumentException">if value has incorrect size</exception>

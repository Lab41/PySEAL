#include "sealnet/UtilitiesWrapper.h"
...
namespace Microsoft
{
    namespace Research
    {
        namespace SEAL
        {
            ...
            BigUInt ^Utilities::PolyInftyNormCoeffmod(BigPoly ^poly, BigUInt ^modulus, MemoryPoolHandle ^pool)
            {
                if (poly == nullptr)
                {
                    throw gcnew ArgumentNullException("poly cannot be null");
                ...
                try
                {
                    auto result = gcnew BigUInt(seal::poly_infty_norm_coeffmod(poly->GetPolynomial(), modulus->GetUInt(), pool->GetHandle()));
                    GC::KeepAlive(poly);
                    GC::KeepAlive(modulus);
                    GC::KeepAlive(pool);
                    return result;
            ...
            void Utilities::ExponentiateUIntMod(BigUInt ^operand, BigUInt ^exponent, BigUInt ^modulus, BigUInt ^destination, MemoryPoolHandle ^pool)
            {
                if (operand == nullptr)
                {
                    throw gcnew ArgumentNullException("operand cannot be null");
                ...
                try
                {
                    seal::exponentiate_uint_mod(operand->GetUInt(), exponent->GetUInt(), modulus->GetUInt(), destination->GetUInt(), pool->GetHandle());
                    GC::KeepAlive(operand);
                    GC::KeepAlive(exponent);
                    GC::KeepAlive(modulus);
                    GC::KeepAlive(destination);
            ...
            BigUInt ^Utilities::ExponentiateUIntMod(BigUInt ^operand, BigUInt ^exponent, BigUInt ^modulus, MemoryPoolHandle ^pool)
            {
                if (operand == nullptr)
                {
                    throw gcnew ArgumentNullException("operand cannot be null");
                ...
                try
                {
                    auto result = gcnew BigUInt(seal::exponentiate_uint_mod(operand->GetUInt(), exponent->GetUInt(), modulus->GetUInt(), pool->GetHandle()));
                    GC::KeepAlive(operand);
                    GC::KeepAlive(exponent);
                    GC::KeepAlive(modulus);
                    GC::KeepAlive(pool);
            ...
            void Utilities::ExponentiatePolyPolymodCoeffmod(BigPoly ^operand, BigUInt ^exponent,
                BigPoly ^polyModulus, BigUInt ^coeffModulus, BigPoly ^destination, MemoryPoolHandle ^pool)
            {
                if (operand == nullptr)
                {
                    throw gcnew ArgumentNullException("operand cannot be null");
                ...
                try
                {
                    seal::exponentiate_poly_polymod_coeffmod(operand->GetPolynomial(), exponent->GetUInt(), polyModulus->GetPolynomial(), 
                        coeffModulus->GetUInt(), destination->GetPolynomial(), pool->GetHandle());
                    GC::KeepAlive(operand);
                    GC::KeepAlive(exponent);
                    GC::KeepAlive(polyModulus);
                    GC::KeepAlive(coeffModulus);
                ...
                BigPoly ^polyModulus, BigUInt ^coeffModulus, MemoryPoolHandle ^pool)
            {
                ...
                try
                {
                    auto result = gcnew BigPoly(seal::exponentiate_poly_polymod_coeffmod(operand->GetPolynomial(), 
                        exponent->GetUInt(), polyModulus->GetPolynomial(), coeffModulus->GetUInt(), pool->GetHandle()));
                    GC::KeepAlive(operand);
                    GC::KeepAlive(exponent);
                    GC::KeepAlive(polyModulus);
                    GC::KeepAlive(coeffModulus);
            ...
            void Utilities::PolyEvalPoly(BigPoly ^polyToEvaluate, BigPoly ^polyToEvaluateAt, BigPoly ^destination, MemoryPoolHandle ^pool)
            {
                if (polyToEvaluate == nullptr)
                {
                    throw gcnew ArgumentNullException("polyToEvaluate cannot be null");
                ...
                try
                {
                    seal::poly_eval_poly(polyToEvaluate->GetPolynomial(), polyToEvaluateAt->GetPolynomial(), 
                        destination->GetPolynomial(), pool->GetHandle());
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(polyToEvaluateAt);
                    GC::KeepAlive(destination);
                    GC::KeepAlive(pool);
            ...
            BigPoly ^Utilities::PolyEvalPoly(BigPoly ^polyToEvaluate, BigPoly ^polyToEvaluateAt, MemoryPoolHandle ^pool)
            {
                if (polyToEvaluate == nullptr)
                {
                    throw gcnew ArgumentNullException("polyToEvaluate cannot be null");
                ...
                try
                {
                    auto result = gcnew BigPoly(seal::poly_eval_poly(polyToEvaluate->GetPolynomial(), 
                        polyToEvaluateAt->GetPolynomial(), pool->GetHandle()));
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(polyToEvaluateAt);
                    GC::KeepAlive(pool);
                    return result;
                ...
                BigPoly ^polyModulus, BigUInt ^coeffModulus, BigPoly ^destination, MemoryPoolHandle ^pool)
            {
                ...
                try
                {
                    seal::poly_eval_poly_polymod_coeffmod(polyToEvaluate->GetPolynomial(), polyToEvaluateAt->GetPolynomial(), 
                        polyModulus->GetPolynomial(), coeffModulus->GetUInt(), destination->GetPolynomial(), pool->GetHandle());
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(polyToEvaluateAt);
                    GC::KeepAlive(polyModulus);
                    GC::KeepAlive(coeffModulus);
                ...
                BigPoly ^polyModulus, BigUInt ^coeffModulus, MemoryPoolHandle ^pool)
            {
                ...
                try
                {
                    auto result = gcnew BigPoly(seal::poly_eval_poly_polymod_coeffmod(polyToEvaluate->GetPolynomial(), 
                        polyToEvaluateAt->GetPolynomial(), polyModulus->GetPolynomial(), coeffModulus->GetUInt(), pool->GetHandle()));
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(polyToEvaluateAt);
                    GC::KeepAlive(polyModulus);
                    GC::KeepAlive(coeffModulus);
            ...
            void Utilities::PolyEvalUIntMod(BigPoly ^polyToEvaluate, BigUInt ^value, BigUInt ^modulus, 
                BigUInt ^destination, MemoryPoolHandle ^pool)
            {
                ...
                try
                {
                    seal::poly_eval_uint_mod(polyToEvaluate->GetPolynomial(), value->GetUInt(), modulus->GetUInt(), 
                        destination->GetUInt(), pool->GetHandle());
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(value);
                    GC::KeepAlive(modulus);
                    GC::KeepAlive(destination);
            ...
            BigUInt ^Utilities::PolyEvalUIntMod(BigPoly ^polyToEvaluate, BigUInt ^value, BigUInt ^modulus, MemoryPoolHandle ^pool)
            {
                if (polyToEvaluate == nullptr)
                {
                    throw gcnew ArgumentNullException("polyToEvaluate cannot be null");
                ...
                try
                {
                    auto result = gcnew BigUInt(seal::poly_eval_uint_mod(polyToEvaluate->GetPolynomial(), 
                        value->GetUInt(), modulus->GetUInt(), pool->GetHandle()));
                    GC::KeepAlive(polyToEvaluate);
                    GC::KeepAlive(value);
                    GC::KeepAlive(modulus);
                    GC::KeepAlive(pool);

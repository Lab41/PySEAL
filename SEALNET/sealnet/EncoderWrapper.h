        ...
        namespace SEAL
        {
            ...
            */
            ...
            public:
                ...
                */
                BinaryEncoder(SmallModulus ^plainModulus, MemoryPoolHandle ^pool);
            ...
            */
            ...
            public:
                ...
                */
                ...
                <remarks>
                Creates a BalancedEncoder object with base set to 3. The constructor takes as input a reference to the 
                plaintext modulus (represented by <see cref="SmallModulus"/>). The user can give a <see cref="MemoryPoolHandle"/>
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                BalancedEncoder(SmallModulus ^plainModulus, MemoryPoolHandle ^pool);
            ...
            */
            ...
            public:
                ...
                */
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                BinaryFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, 
            ...
            */
            ...
            public:
                ...
                */
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                BalancedFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount, MemoryPoolHandle ^pool);
                ...
                */
                BalancedFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount, System::UInt64 base);
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                BalancedFractionalEncoder(SmallModulus ^plainModulus, BigPoly ^polyModulus, int integerCoeffCount, int fractionCoeffCount, System::UInt64 base, MemoryPoolHandle ^pool);
                ...
                */
                ...
                <exception cref="System::ArgumentNullException">if plain is null</exception>
                <exception cref="System::ArgumentException">if plain does not represent a valid plaintext polynomial</exception>
                <exception cref="System::ArgumentException">if either the integral part does not fit in System::Int64 (#ifdef SEAL_THROW_ON_DECODER_OVERFLOW)</exception>
                */
                double Decode(Plaintext ^plain);
            ...
            */
            ...
            public:
                ...
                */
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                IntegerEncoder(SmallModulus ^plainModulus, MemoryPoolHandle ^pool);
                ...
                */
                ...
                <remarks>
                Creates an IntegerEncoder object. The constructor takes as input a reference to the plaintext modulus 
                (represented by <see cref="SmallModulus"/>), and an integer, at least 2, that is used as a base 
                ...
                <seealso cref="MemoryPoolHandle">See MemoryPoolHandle for more details on memory pool handles.</seealso>
                */
                IntegerEncoder(SmallModulus ^plainModulus, System::UInt64 base, MemoryPoolHandle ^pool);

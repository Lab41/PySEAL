...
namespace Microsoft
{
    namespace Research
    {
        namespace SEAL
        {
            ...
            of a BigPoly array. The size of the array (which can be read with <see cref="Size" />) is set initially 
            by the constructor and can be resized either with the <see cref="Resize()"/> function or with the 
            <see cref="Set()"/> function. Each polynomial in the array must have the same coefficient count and 
            coefficient bit count, which can be set in the constructor or with the <see cref="Resize" /> function, 
            and read with <see cref="CoeffCount" /> and <see cref="CoeffBitCount"/>. The index functions allow
            reading/writing individual BigPoly's in the array by returning references to them. The array can be 
            saved and loaded from a stream with the <see cref="Save()"/> and <see cref="Load()"/> functions.
            </para>
            <para>
            ...
            the array may be freed whenever a <see cref="Resize()"/> occurs, the BigPolyArray instance is destroyed,
            ...
            */
            public ref class BigPolyArray : System::IEquatable<BigPolyArray^>
            {
            public:
                /**
                ...
                */
                ...
                <exception cref="System::ArgumentOutOfRangeException">if polyIndex is not within 
                [0, <see cref="Size"/>)</exception>
                */
                ...
                */
                virtual bool Equals(BigPolyArray ^compare);

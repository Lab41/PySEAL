...
namespace Microsoft
{
    namespace Research
    {
        namespace SEAL
        {
            ...
            bit count for a BigUInt (which can be read with <see cref="BitCount"/>) is set initially by the constructor and can
            be resized either explicitly with the <see cref="Resize()"/> function or implicitly with an assignment operation
            ...
            own memory allocation and/or to prevent unnecessary copying. For example, <see cref="BigPoly"/> uses aliased
            BigUInt's to return BigUInt representations of its coefficients, where the aliasing allows read/writes to the
            BigUInt to refer directly to the coefficient's corresponding region in the backing array of the <see cref="BigPoly"/>.
            </para>
            ...
            <see cref="Pointer"/>. When it is known that a resize will not occur, concurrent reading and mutating will not
            ...
            */
            ...
            public:
                ...
                */
                ...
                string. The string must match the format returned by <see cref="ToString()"/> and must consist of only the characters 0-9, A-F, or
                ...
                */
                ...
                string matches the format returned by <see cref="ToString()"/> and must consist of only the characters 0-9, A-F, or
                a-f, most-significant nibble first.
                </remarks>
                ...
                */
                ...
                /**
                <summary>Creates a BigUInt initialized and minimally sized to fit the unsigned hexadecimal integer specified by the
                <see cref="System::Numerics::BigInteger"/>.</summary>

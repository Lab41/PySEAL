...
namespace seal
{
    namespace util
    {
        PolyModulus::PolyModulus() : poly_(nullptr), coeff_count_(0), coeff_uint64_count_(0), coeff_count_power_of_two_(-1), is_one_zero_one_(false)
        {
        }

        PolyModulus::PolyModulus(const uint64_t *poly, int coeff_count, int coeff_uint64_count) : poly_(poly), coeff_count_(coeff_count), coeff_uint64_count_(coeff_uint64_count),

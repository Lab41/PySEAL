...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            return (parms.plain_modulus().bit_count() >= max_abs_value_.significant_bit_count() &&
    ...
    */
    ...
    public:
        ...
        */
        ChooserEvaluator(const MemoryPoolHandle &pool = MemoryPoolHandle::Global()) : pool_(pool)
        {
        }
        ...
        */
        ...
        /**
        Returns the default set of (degree(polynomial modulus), coeff_modulus)-pairs. The functions returns 
        an std::map<int,std::vector<SmallModulus> >, where the degree of the polynomial modulus acts as the 
        key, and the corresponding value is the vector of SmallModulus objects intended to be used as the 
        coefficient modulus in EncryptionParameters. An expert user might want to give a modified map as 
        an argument to select_parameters() for better results in automatic parameter selection.
        */
        static const std::map<int, std::vector<SmallModulus> > &RNSdefault_parameter_options()
        {
            return RNSdefault_parameter_options_;
        }
    ...
    private:
        ...
        static const std::map<int, std::vector<SmallModulus> > RNSdefault_parameter_options_;

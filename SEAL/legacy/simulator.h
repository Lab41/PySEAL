...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        Simulation(const EncryptionParameters &parms, int ciphertext_size, int noise_budget);
        ...
        */
        ...
        {
            return std::max(0, parms_.coeff_modulus().bit_count() - noise_.significant_bit_count() - 1);
        }
    ...
    */
    ...
    public:
        ...
        */
        SimulationEvaluator(const MemoryPoolHandle &pool = MemoryPoolHandle::Global()) : pool_(pool)
        {
        }
        ...
        */
        Simulation get_fresh(const EncryptionParameters &parms, int plain_max_coeff_count, const BigUInt &plain_max_abs_value);
        ...
        */
        Simulation get_fresh(const EncryptionParameters &parms, int plain_max_coeff_count, std::uint64_t plain_max_abs_value);
        ...
        */
        inline Simulation sub_plain(const Simulation &simulation, int plain_max_coeff_count, const BigUInt &plain_max_abs_value)
        {

...
namespace seal
{
    ...
    */
    ...
    public:
        /**
        Creates an Evaluator instance initialized with the specified SEALContext and evaluation 
        ...
        */
        Evaluator(const SEALContext &context, const EvaluationKeys &evaluation_keys, 
            const MemoryPoolHandle &pool = MemoryPoolHandle::Global());

        /**
        Creates an Evaluator instance initialized with the specified SEALContext. Optionally, 
        ...
        @see MemoryPoolHandle for more details on memory pool handles.
        */
        Evaluator(const SEALContext &context, const MemoryPoolHandle &pool = MemoryPoolHandle::Global())
            : Evaluator(context, EvaluationKeys(), pool)
        {
        }
        ...
        */
        ...
        coefficient values less than the plain modulus (SEALContext::plain_modulus()).
        ...
        */
        ...
        less than the plain modulus (SEALContext::plain_modulus()). 
    ...
    private:
        ...
        util::Pointer mod_product_upper_half_threshold_;
